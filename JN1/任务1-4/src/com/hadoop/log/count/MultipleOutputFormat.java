...
extends FileOutputFormat<K, V> {  
	...
	public class MultiRecordWriter extends RecordWriter<K, V> {  
		...
		private RecordWriter<K, V> getBaseRecordWriter(TaskAttemptContext job, String baseName)  
           ...
           String keyValueSeparator = System.getProperty("line.separator", "\n");  
           ...
           if (isCompressed) {  
        	  ...
        	  FSDataOutputStream fileOut = file.getFileSystem(conf).create(file, false);              recordWriter = new LineRecordWriter<K, V>(fileOut, keyValueSeparator);  
           }  
           return recordWriter;
       }
	}
